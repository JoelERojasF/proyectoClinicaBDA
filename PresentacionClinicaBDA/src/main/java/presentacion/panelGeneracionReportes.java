...
public class panelGeneracionReportes extends javax.swing.JPanel {
    ...
    if (item == null) {
        JOptionPane.showMessageDialog(this, "Debe seleccionar un cliente primero.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) {
        ...
        boolean exito = resultadoBO.exportarReporteAPDF(item.getId(), rutaDestino);
        
        if (exito) {
            JOptionPane.showMessageDialog(this, "¡PDF generado con éxito en:\n" + rutaDestino + "!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Ocurrió un error al intentar crear el PDF.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
